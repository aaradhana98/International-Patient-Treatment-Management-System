...
class IPTreatmentOfferingsServiceTest {
	...
	public void test_GetIPTreatmentPackageByAilmentCategoryAndName() {
		...
		when(ipTreatmentOfferingsRepository.findByName("Package1", "Urology")).thenReturn(iPTreatmentPackage1);
		when(ipTreatmentOfferingsRepository.findByName("Package2", "Orthopaedics")).thenReturn(iPTreatmentPackage2);
		when(ipTreatmentOfferingsRepository.findByName("Package2", "Urology")).thenReturn(null);
